class MovementController {
    ...
    getMovements = async (req, res, next) => {
        ...
        try {
            const movements = await this.movementService.findAllByUserId(req.userId);
    ...
    getMovementsByCategory = async (req, res, next) => {
        ...
        try {
            ...
            const movements = await this.movementService.findByCategory({userId : req.userId, categoryId});
            if (!movements || movements?.length === 0) {
    ...
    getAllIncomes = async (req, res, next) => {
        ...
        try {
            const incomes = await this.movementService.getAllIncomes(req.userId);
    ...
    getAllExpenses = async (req, res, next) => {
        ...
        try {
            const expenses = await this.movementService.getAllExpenses(req.userId);
